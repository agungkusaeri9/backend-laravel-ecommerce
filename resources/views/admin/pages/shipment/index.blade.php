                        ...
                        <tbody>
                            @foreach ($shipments as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.shipments.edit',$item->id) }}" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('admin.shipments.destroy',$item->id) }}" method="post" class="d-inline">
                                            @csrf
                                            @method('delete')
