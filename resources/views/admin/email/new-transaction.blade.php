...
<head>
    ...
    <style>
        * {
        ...
        table.info-transaction tr th, table.info-pembayaran tr th  {
           font-weight: normal;
        }
        table.detail-produk {
...
<body>
    <div class="wrapper">
        <p>Halo Admin, ada transaksi baru yang dibuat oleh {{ $data->user->name }} pada hari {{ $data->created_at->translatedFormat('l, d F Y H:i') }} <br>
        ...
        <p style="margin-top: 30px;">Silahkan cek apakah sudah melakukan pembayaran dengan metode pembayaran diatas.</p>
        <p>Kalau sudah, jangan lupa update status transaksinya ke deliveri ataupun ke sukses.</p>
    </div>
</body>
